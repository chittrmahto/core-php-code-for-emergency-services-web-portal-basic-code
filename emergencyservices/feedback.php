<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
       ...
       mysql_query("INSERT INTO feedback(name,email,mobile,address,pincode,created_ip,is_status) VALUES ('$name','$email','$mobile','$address','$pincode','$created_ip','$is_status')"); //SQL query
    ...
    <div class="container" style="margin-top: 20px;">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<section>
			      <h1 class="section-header" style="text-align: center;">Feedback Form</h1>
			      <div class="container">
