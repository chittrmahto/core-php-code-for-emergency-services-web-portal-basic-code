<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
       ...
       mysql_query("INSERT INTO aids_helpline(name,email,mobile,address,pincode,created_ip,is_status) VALUES ('$name','$email','$mobile','$address','$pincode','$created_ip','$is_status')"); //SQL query
...
<?php include("header.php");?>
    ...
    <div class="container" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6">
				<section>
			      <h1 class="section-header" style="text-align: center;">Aids helpline Contact Form</h1>
			      <div class="container">
