<?php
	...
	$query = mysql_query("Select * from aids_helpline"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="aids_helpline.php" class="list-group-item active">AIDS helpline</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">AIDS helpline contact request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
