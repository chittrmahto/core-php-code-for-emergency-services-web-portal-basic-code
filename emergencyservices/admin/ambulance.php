<?php
	...
	$query = mysql_query("Select * from ambulance"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="ambulance.php" class="list-group-item active">Ambulance</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Ambulance contact request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
