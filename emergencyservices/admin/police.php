<?php
	...
	$query = mysql_query("Select * from police"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	          	<h4>Services List</h4>
	            <a href="police.php" class="list-group-item active">Police</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Police contact request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
