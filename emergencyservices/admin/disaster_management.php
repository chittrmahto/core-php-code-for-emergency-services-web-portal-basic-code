<?php
	...
	$query = mysql_query("Select * from disaster_management"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="disaster_management.php" class="list-group-item active">Disaster management</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Disaster Management request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
