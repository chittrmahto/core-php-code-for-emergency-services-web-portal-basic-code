<?php
	...
	$query = mysql_query("Select * from chil_abuse_hotline"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="child_abuse_hotline.php" class="list-group-item active">Child abuse hotline</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Child Abuse Hotline contact request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
