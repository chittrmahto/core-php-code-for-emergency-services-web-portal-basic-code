<?php
	...
	$query = mysql_query("Select * from air_ambulance"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="air_ambulance.php" class="list-group-item active">Air ambulance</a>
	          </div>
	          <div>&nbsp;</div>
	          <div class="list-group">
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Air ambulance contact request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
