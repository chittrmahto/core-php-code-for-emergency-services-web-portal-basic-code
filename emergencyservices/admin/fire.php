<?php
	...
	$query = mysql_query("Select * from fire_brigade"); 
	    ...
	    <div class="row" style="margin-top:80px;">
		    <div class="col-lg-3">
	          ...
	          <div class="list-group">
	            ...
	            <a href="fire.php" class="list-group-item active">Fire Brigade</a>
	        ...
	        <!-- /.col-lg-3 -->
		    <div class="col-md-9">
		        <h2 style="text-align: center;">Fire Brigade request list</h2>
		        <?php echo $listmg; ?>
		    </div>
		</div>
    </div>
